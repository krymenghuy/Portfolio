        ...
        <div className="flex flex-col items-center justify-center md:flex-row md:gap-8 lg:gap-12">
          ...
          >
            ...
            >
              <motion.button
                ...
                className="w-full px-6 py-3 font-semibold text-white transition-all duration-300 rounded-lg shadow-lg sm:w-auto bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700"
              >
                View My Work
              </motion.button>
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full px-6 py-3 font-semibold text-center text-white transition-all duration-300 border rounded-lg sm:w-auto bg-white/10 backdrop-blur-sm hover:bg-white/20 border-white/20"
              >
                Download Resume
              </motion.a>
            </motion.div>
            ...
            <motion.div
              variants={textVariants}
              className="flex justify-center mb-6 space-x-6 md:justify-start"
            >
              <motion.a
                whileHover={!isMobile ? { 
                  scale: 1.3, 
          ...
          >
            <div className="relative">
              ...
              <div className="relative w-40 h-40 overflow-hidden bg-gray-900 border-2 rounded-full sm:w-60 sm:h-60 md:w-72 md:h-72 lg:w-80 lg:h-80 border-cyan-400/50">
              ...
              {/* Enhanced floating elements - Disable on mobile */}
              {!isMobile && (
                <>
                  <motion.div
                    animate={{ 
